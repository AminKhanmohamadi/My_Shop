...
class Product(models.Model):
    ...
    image_product = models.ImageField(upload_to='product' , null=True , blank=True,verbose_name='عکس محصول')
    brand = models.ForeignKey(ProductBrand , on_delete=models.CASCADE, verbose_name='برند' , null=True , blank=True)
    price = models.IntegerField(verbose_name='قیمت')
    short_description = models.CharField(max_length=600, db_index=True, null=True, verbose_name='توضیحات کوتاه')
